  ...
  return (
    <main className="relative flex-1 overflow-hidden bg-[#F5F7F2]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute right-0 top-0 h-[450px] w-[450px] rounded-full bg-slate-500/5 blur-3xl" />

        <div className="absolute bottom-0 left-0 h-[350px] w-[350px] rounded-full bg-zinc-500/5 blur-3xl" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <header className="sticky top-0 z-30 border-b border-slate-200/70 bg-white/80 backdrop-blur-xl">
          <div className="flex flex-col gap-6 px-8 py-6 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex items-center gap-5">
              <div className="flex h-20 w-20 items-center justify-center rounded-[28px] bg-gradient-to-br from-slate-700 to-slate-900 text-white shadow-2xl">
        ...
        <div className="grid gap-6 p-8 md:grid-cols-3">
          <Card className="overflow-hidden rounded-[32px] border-0 bg-white shadow-xl shadow-slate-100/30">
          ...
          <Card className="overflow-hidden rounded-[32px] border-0 bg-white shadow-xl shadow-zinc-100/30">
            <CardContent className="relative p-7">
